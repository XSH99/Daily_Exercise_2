...
public class EmployeesControler {
    ...
    public Response getAllEmployees(@BeanParam EmployeesFilterDto filter) throws SQLException, ClassNotFoundException {
        ...
        GenericEntity<ArrayList<Employees>>  employee = new GenericEntity<ArrayList<Employees>> (dao.selectAllEmployee(filter.getYear())){};
        try {
...
//    }
    ...
    public Response insertEmployees(Employees employees) {
        try {
            dao.setInsertEmployees(employees);
...
//    }
    ...
    public void updateEmployees(@PathParam("employees_id") int employees_id, Employees employees) {
        ...
        try {
            ...
            dao.setUpdateEmployees(employees);
        } catch (Exception e) {
            throw new RuntimeException(e);
        }
    }
