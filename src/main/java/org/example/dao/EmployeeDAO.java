...
public class EmployeeDAO {
    ...
    private static final String selectEmployees_name = "select * from employees where first_name = ?";
...
//    }
    ...
    public Employees selectEmployees_name(String first_name) throws SQLException, ClassNotFoundException {
        Class.forName("org.sqlite.JDBC");
        Connection conn = DriverManager.getConnection(URL);
        PreparedStatement st = conn.prepareStatement(selectEmployees_name);
    ...
    public ArrayList<Employees> selectAllEmployee(String year) throws SQLException, ClassNotFoundException {
        Class.forName("org.sqlite.JDBC");
        Connection conn = DriverManager.getConnection(URL);
